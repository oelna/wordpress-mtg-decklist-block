...
/*
// Auto-updates from Github, via: https://github.com/rudrastyh/misha-update-checker
if( ! class_exists( 'mtgdlUpdateCheck' ) ) {

	class mtgdlUpdateCheck{
